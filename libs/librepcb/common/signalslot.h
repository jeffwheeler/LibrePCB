...
public:
  ...
  void notify(Args... args) noexcept {
    ...
    // shared copy of the container. This is very important since the callback
    // might modify the container while iterating over it! With std containers
    // this would be much more complicated (or less efficient).
